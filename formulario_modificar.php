...
<body>
	...
	<section id="mantenimiento">
		...
		<p style="text-align:center">Ingrese el numero de factura y codigo de articulo para modificar</p>
		<table align="center">
			<form action="formulario_modificar.php" method="post" id="formulario">
				...
				<tr>
					...
					<td><input type="text" name="codigo_persona" id="codigo_empleado" onkeypress="buscar_empleado();" class="requerido"/></td>
				</tr>
				<tr>
				...
				<tr>
					<td>Cantidad:</td>
					<td><input type="text" name="cantidad" id="cantidad" onkeypress="calcular_descuento()" class="requerido"/></td>
				</tr>
				<tr>
					<td>Total detalle:</td>
				...
				<tr>
					<td>Descuento:</td>
					<td><input type="text" name="descuento" id="descuento" readonly/ class="requerido"></td>
				</tr>
				<tr>
